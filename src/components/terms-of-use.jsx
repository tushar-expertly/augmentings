    ...
    <Layout>
      <div className="bg-emerald-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            Content on the Augmentings website may be protected by U.S. and
          ...
          <p className="mb-4">
            ...
            Augmentings strives for accuracy but cannot guarantee the
            reliability of third-party information. Augmentings is not
            responsible for actions taken based on this information or for any
            resulting consequences.
          </p>
          <p className="mb-4">External Links</p>
          <p className="mb-4">
            Augmentings’s website may include links to external sites maintained
            ...
            endorsement by Augmentings. Links may be removed or updated at any
            time without notice.
          </p>

          <p className="mb-4">
            For concerns about linked external sites, please contact the
            respective organizations. Augmentings is not responsible for the
