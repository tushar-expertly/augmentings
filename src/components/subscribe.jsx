      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
          ...
          <p className="max-w-4xl mt-6 text-center text-gray-500 dark:text-gray-300">
            For regulatory compliance and healthcare professionals eager to keep
            up with the latest developments, Augmentings is your ideal resource
          </p>
          <p className="max-w-4xl mt-6 text-center text-gray-500 dark:text-gray-300">
            Subscribe to access a wealth of insightful, industry-specific
            information and stay informed about the latest news and advancements
            in your field.
          </p>
        </div>
      </section>
              ...
              <div className="mt-4">
                <div className="flex items-start mb-5">
                  ...
                  <label htmlFor="remember" className="ms-2 text-sm  ">
                    I agree to receive information about Augmentings.com
                    training
                  </label>
                </div>
              </div>
